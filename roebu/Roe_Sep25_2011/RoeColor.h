...
namespace roe {
	...
	public:
		...
		unsigned char byter() const {return (unsigned char)(256*std::max(0.0f,std::min(0.99999f,r)));}
		unsigned char byteg() const {return (unsigned char)(256*std::max(0.0f,std::min(0.99999f,g)));}
		unsigned char byteb() const {return (unsigned char)(256*std::max(0.0f,std::min(0.99999f,b)));}
		unsigned char bytea() const {return (unsigned char)(256*std::max(0.0f,std::min(0.99999f,a)));}
