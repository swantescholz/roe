...
namespace roe {
	...
	public:
		...
		double normal     (double min,  double max)                {return (max - min) * (static_cast<double>(rand()) / RAND_MAX) + min;} //wrong
		double exponential(double min,  double max)                {return (max - min) * (static_cast<double>(rand()) / RAND_MAX) + min;} //wrong//*/
