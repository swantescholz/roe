...
namespace roe {
	...
	public:
		...
		float   distance2      (const Vector2& v) const {return      (x-v.x)*(x-v.x)+(y-v.y)*(y-v.y) ;}
		...
		static float   distance2      (const Vector2& a, const Vector2& b)  {return (b-a).length2();}
		static Vector2 midPoint       (const Vector2& a, const Vector2& b)  {return (a+b)*0.5f;}
		static float   length         (const Vector2& v)                   {return sqrt(v.x*v.x+v.y*v.y);}
		static float   length2        (const Vector2& v)                   {return v.x*v.x+v.y*v.y;}
		...
		static Vector2 dot         (const Vector2& a, const Vector2& b) {return a.x*b.x + a.y*b.y;}
